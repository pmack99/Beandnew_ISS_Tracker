      ...
      $.ajax({
        ...
        .then(function (response) {
          ...
          if (passesCount == 0) {
            ...
            var cityTitle = $("#cityTitleTxt").text(cityState);
            var accordionButton = $("#accordionButton").append( 
                '<div id="accordion">' + '<button class="btn btn-lg btn-block accordionHeading" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">' +
                '<div id="cityTitleTxt"></div>' + '</button>');
            // var accordionStart = ;
            // var accordionEnd = ;
              
              var newRow = $("#accordionContent").append( //tr
              ...
              $("#accordionsResults").prepend(accordionButton + newRow + '</div>'); //tbody
